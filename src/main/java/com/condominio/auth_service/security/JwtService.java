...
public class JwtService {
    ...
    // Geração de token com informações do usuário
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return Jwts
                ...
                .setSubject(userDetails.getUsername()) // e-mail ou username
    ...
    // Validação do token com os dados do usuário
    ...
    // Chave usada para assinar/verificar o token
